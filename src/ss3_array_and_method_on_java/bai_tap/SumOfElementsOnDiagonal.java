...
public class SumOfElementsOnDiagonal {
    public static void main(String[] args) {
        ...
        System.out.println("<----------------------------------------Sum of elements on the main diagonal-------------------------------------------------->\n");
        int sum = 0;
        for (int row = 0; row < matrix.length; row++) {
            for (int column = 0; column < matrix[row].length; column++) {
                if (row == column) {
        ...
        System.out.print("Sum of elements on the main diagonal is " + sum);
    }
}
